...
public class ArticleBuilder {
    ...
    public void buildTags() {
        ...
        if (tags != null && !tags.equals("") && !tags.equals("null")) {
            for (String text : tags.split(",")) {
                Tag tag = new Tag(context, text);
     ...
     * Tag
     */
    private class Tag extends CardView {
        /**
         * Shared preferences
         */
        ...
        public Tag(Context context, String text) {
            ...
            if (key != null) {
                ...
                statusTextView.setPadding(0, 4, 4, 4);
                statusTextView.setTextSize(TypedValue.COMPLEX_UNIT_SP, P_SIZE);
